    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-6xl mx-auto px-4 py-8">
        {activeSection === 'calculator' && (
          <MainCalculator onResult={handleCalculatorResult} initialData={calculatorData} />
        )}
        {activeSection === 'advanced' && <AdvancedCalculator />}
        {activeSection === 'timeline' && (
          <Timeline asset={selectedAsset} calculatorData={calculatorData} />
        )}
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center">
            ...
            <div className="mt-6 text-sm text-muted-foreground">
              Developed by{' '}
              <a
                href="https://portfolio.tomasriera.com"
                target="_blank"
